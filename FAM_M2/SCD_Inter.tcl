...
################################################################
# This is a generated script based on design: SCD_Inter
#
...
# /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynSCDHalf/solution_111_3_24242424/impl \
# /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynM2OHalf/solution_111_3_24242424/impl \
# /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynM2MHalf/solution_111_3_24242424/impl \
# } [current_project]
#update_ip_catalog
set_property  ip_repo_paths  {
 /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynSCDFull/solution_111_3_24242424/impl \
 /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynM2OFull/solution_111_3_24242424/impl \
 /home/jingyi/SCDfunctions/Paper/Synthesis_M2_SCD/src/SynM2MFull/solution_111_3_24242424/impl \
 } [current_project]
update_ip_catalog
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:Multi2Multi:1.0\
xilinx.com:hls:Multi2One:1.0\
xilinx.com:ip:axi_dma:7.1\
xilinx.com:ip:smartconnect:1.0\
xilinx.com:hls:model_SCD:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Multi2Multi_0, and set properties
  set Multi2Multi_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Multi2Multi:1.0 Multi2Multi_0 ]

  # Create instance: Multi2One_0, and set properties
  set Multi2One_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Multi2One:1.0 Multi2One_0 ]
  ...
  # Create instance: model_SCD_0, and set properties
  set model_SCD_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:model_SCD:1.0 model_SCD_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins model_SCD_0/i_AXI_in]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins model_SCD_0/q_AXI_in]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins Multi2Multi_0/ap_rst_n] [get_bd_pins Multi2One_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins axi_dma_4/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins model_SCD_0/ap_rst_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins Multi2Multi_0/ap_clk] [get_bd_pins Multi2One_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_dma_4/m_axi_s2mm_aclk] [get_bd_pins axi_dma_4/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins model_SCD_0/ap_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
