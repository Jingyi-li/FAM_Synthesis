...
typedef ap_fixed<F1f+1, 2, AP_RND, AP_SAT> double_fixed_t; // 256-pt FFT intermediate <32, 2>
...
typedef ap_fixed<F2f+1, 2, AP_RND, AP_SAT> double_fixed_t3; // 32-pt FFT intermediate <32, 2>
typedef ap_fixed<F2f, 1, AP_RND, AP_SAT> single_fixed_t4; // 32-pt FFT <24, 1>
typedef ap_fixed<F2f+F2f, 2, AP_RND, AP_SAT> double_fixed_Mag; // 32-pt FFT <24, 1>
// verified!
